...
stacker_detect_package_manager() {
...
stacker_auto_install_deps() {
    ...
    stacker_debug "Detected package manager: $pm"
    ...
    case "$pm" in
        ...
        zypper)
            ...
            ;;
        *)
            stacker_error "No supported package manager found"
            return 1
            ;;
    esac
...
core_list_functions() {
    ...
    echo "stacker_detect_os stacker_detect_package_manager stacker_check_requirements"
